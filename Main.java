...
class Car {
    ...
    public double calculatePrice(int rentalDays) {
        ...
        if (rentalDays > 7) {
            price *= 0.9; // 10% discount for rentals > 7 days
        }
        return price;
    }
...
class CarRentalSystem {
    ...
    public void searchCar(String keyword) {
        ...
        boolean found = false;
        for (Car car : cars) {
            // Search keyword is case-insensitive for carId, brand, and model
            if ((car.getCarId().toLowerCase().contains(keyword.toLowerCase())
        ...
        if (!found) {
            System.out.println("No cars match your search or are currently unavailable.");
        }
    }
    ...
    public void menu() {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3 -> {
                    System.out.print("\nEnter a brand or model to search: ");
                    String keyword = scanner.nextLine();
                    searchCar(keyword);
                }
                case 4 -> displayRentalHistory();
                case 5 -> {
